...
task :update, :version do |t, args|
  ...
  mappings = {
    ...
    "gantt.src.js"                  => "highcharts/modules/gantt.js",
    "grid-axis.src.js"              => "highcharts/modules/grid-axis.js",
    ...
    "overlapping-datalabels.src.js" => "highcharts/modules/overlapping-datalabels.js",
    ...
    "xrange-series.src.js"          => "highcharts/modules/xrange-series.js",
  }
